...
db.exec(`
  CREATE TABLE biomass_burners (
    ...
    coordinate_source TEXT NOT NULL DEFAULT 'default',created_at INTEGER NOT NULL,updated_at INTEGER NOT NULL
  );
  ...
  INSERT INTO biomass_burners VALUES ('IO2729MB1','Lò thật','Đà Nẵng',16.03143,108.189156,'manual',100,200);
...
try {
  ...
  const page = migrated.prepare('SELECT * FROM system_pages WHERE page_id=?').get('biomass-refuel-io2729mb1');
