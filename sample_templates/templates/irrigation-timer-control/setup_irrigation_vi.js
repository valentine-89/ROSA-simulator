(function () {
  ...
  function setupTitleText() {
    ...
    if (true) return "Cài đặt hẹn giờ tưới tiêu";
  ...
  function listTitle() {
    ...
    if (true) return "Danh sách khu tưới";
  ...
  function setupShell() {
    ...
    var withList = false || false || true || false;
  ...
  function normalizeItems(preserveAdvanced) {
    ...
    if (true) state.items = state.items.map(makeIrrigationGroup);
